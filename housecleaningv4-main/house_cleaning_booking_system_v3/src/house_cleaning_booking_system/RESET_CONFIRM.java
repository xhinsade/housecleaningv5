...
public class RESET_CONFIRM extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(rc_verificationcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 220, 237, 30));

        rc_phonenumber.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        jPanel2.add(rc_phonenumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 237, 30));
        ...
        jPanel2.add(rc_sendcodebutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 220, -1, 20));
    ...
    private void rc_resetpasswordbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rc_resetpasswordbuttonActionPerformed
      ...
      String password = rc_newpassword.getText();
      String number = rc_phonenumber.getText();
      String verify = rc_verificationcode.getText();

if (number.isEmpty() || username.isEmpty() || password.isEmpty() || verify.isEmpty()) {
    ...
    int option = JOptionPane.showConfirmDialog(null, "Are you sure you want to reset your paasword this account?", "Confirmation", JOptionPane.YES_NO_OPTION);
    if (option == JOptionPane.YES_OPTION) {
        JOptionPane.showMessageDialog(null, "You've successfully reset your password account");
